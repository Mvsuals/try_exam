...
import EnsemblePostList from "../components/page-exclusive/ensemble-post-list";
import EnsemblePageCSS from "./EnsemblePage.module.css"


const EnsemblePage = () => {
    const { id } = useParams();
    const { data: ensemble, isLoading, error } = useFetch('http://127.0.0.1:3000/ensemble/' + id)
    ...
    return ( 
        <div className={EnsemblePageCSS.default}>
            ...
            { ensemble && <EnsemblePostList ensemble={ensemble}/>}
        </div>
     );
}
